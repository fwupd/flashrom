...
int flashrom_read_buf_from_file(unsigned char *buf, unsigned long size, const char *filename);
int flashrom_write_buf_to_file(const unsigned char *buf, unsigned long size, const char *filename);
